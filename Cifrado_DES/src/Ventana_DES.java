 ...
 * @author sosar
 */
public class Ventana_DES extends javax.swing.JFrame {
String seer;
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Por favor, ingresa el texto a cifrar");
        ...
        jLabel2.setText("Por favor, ingrese la clave para cifrar");
        ...
        jButton3.setText("Ir a descifrado");
    ...
    try {
        pepeElToro.encriptar(seer, CT2.getText());
    } catch (Exception ex) {
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        new Ventana_DES2().setVisible(true);
        dispose();
